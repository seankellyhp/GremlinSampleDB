...
namespace GremlinNetSample
{
    ...
    class Program
    {
        ...
        private static Dictionary<string, string> gremlinQueries = new Dictionary<string, string>
        {
            ...
            { "AddVertex 1",    "g.addV('Customers').property('buzz_id', 'auto-test').property('name', 'lb-test').property('status', 'inactive')" },
            { "AddVertex 2",    "g.addV('Customers').property('buzz_id', 'auto-test2').property('name', 'lb-test2').property('status', 'active')" }
